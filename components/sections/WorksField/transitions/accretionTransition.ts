...
class AccretionTransition implements MarkTransitionStrategy {
  ...
  private buildCrystalLayer(
    ...
    const { matrices, order } = placeAccretionCrystals({
      ...
      depth: this.options.depth * chunks.thicknessScale,
      targetSize: this.options.targetSize,
      siteSpacing: ACCRETION_TUNING.crystalSiteSpacing * chunks.thicknessScale,
      ...
      length: ACCRETION_TUNING.crystalLength * chunks.thicknessScale,
      lengthJitter: 0.45,
