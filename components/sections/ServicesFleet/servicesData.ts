...
export const FLEET_SERVICES: FleetService[] = [
  ...
  },
  {
    ...
    modelPath: PLACEHOLDER_VESSEL, // → /models/saas.glb
  },
  {
    index: '03',
    ...
    modelPath: PLACEHOLDER_VESSEL, // → /models/crm.glb
  },
  {
    index: '04',
    ...
    modelPath: PLACEHOLDER_VESSEL, // → /models/mobile.glb
  },
  {
    index: '05',
    name: 'AI Solutions',
    ...
    modelPath: PLACEHOLDER_VESSEL, // → /models/ai.glb
  },
  {
    index: '06',
    ...
    modelPath: PLACEHOLDER_VESSEL, // → /models/design.glb
  },
];
